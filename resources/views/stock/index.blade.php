                            ...
                            <tbody>
                                @forelse($movements as $move)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <span class="badge bg-{{ $move->type === 'in' ? 'success' : 'danger' }} rounded-pill px-3 py-2">
                                                <i class="fas fa-{{ $move->type === 'in' ? 'arrow-down' : 'arrow-up' }} me-1"></i>
                ...
                <div class="alert alert-info">
                    <div class="d-flex">
                        ...
                        <div>
                            ...
                            <p class="mb-0 small">Use "IN" for receiving new inventory and "OUT" for sales or adjustments.</p>
                        </div>
                    </div>
                </div>
            </div>
